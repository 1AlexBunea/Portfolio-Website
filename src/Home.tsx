        ...
        <div>
            <div className='container' style={{
                ...
                <div style={{
                    ...
                    <br></br>
                    <div>
                        <button className="link-button" onClick={() => window.open("https://github.com/1AlexBunea")} style={{padding: 15}}>
                        ...
                        <button className="link-button" onClick={() => window.open("https://www.linkedin.com/in/alex-bunea-8901751b6/")} style={{padding: 15}}>
                        ...
                        <button className="link-button" onClick={() => window.location.href = "mailto:alexbunea@utexas.edu?subject=Subject%20Here&body=Body%20content%20here"} style={{padding: 15}}>
